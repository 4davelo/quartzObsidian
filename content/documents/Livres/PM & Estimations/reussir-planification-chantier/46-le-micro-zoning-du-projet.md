...
ordre_document: 46
titre: "Le micro-zoning du projet"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 46 Le micro-zoning du projet
resume_section: |-
  Le micro-zoning est une étape clé en Lean Construction, structurant le planning chemin de fer et facilitant le pilotage du chantier. Les zones, représentées en ordonnées sur le planning, respectent la physique du bâtiment (étages supérieurs en haut). Cette organisation optimise la visualisation des contraintes, comme le hors d’eau provisoire, et permet une meilleure anticipation.
  
  Les zones sont regroupées par typologies (logements, bureaux, halls, etc.), passant du macro au micro-zoning. Le pilotage se concentre souvent sur des micro-zones (150-250 m²), adaptées pour un travail de plusieurs jours mais inférieur à une semaine. Un zoning cohérent, respectant la géométrie de l’ouvrage, facilite la compréhension et la gestion par les acteurs du projet.
...
section_precedente: "[[45-le-parametrage-du-planning-chemin-de-fer|Le paramétrage du planning chemin de fer]]"
section_suivante: "[[47-application-6-1|Application 6-1]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["46_6.3_le_micro-zoning_du_projet.md"]
created: 2026-04-30
updated: 2026-04-30
...
![[documents/Livres/PM & Estimations/reussir-planification-chantier/images/Réussir_la_planification_d'un_chantier_--_2023_--_Le_Moniteur.epub-0225-03.png]]
...
![[documents/Livres/PM & Estimations/reussir-planification-chantier/images/Réussir_la_planification_d'un_chantier_--_2023_--_Le_Moniteur.epub-0226-02.png]]
...
![[documents/Livres/PM & Estimations/reussir-planification-chantier/images/Réussir_la_planification_d'un_chantier_--_2023_--_Le_Moniteur.epub-0228-00.png]]
...
![[documents/Livres/PM & Estimations/reussir-planification-chantier/images/Réussir_la_planification_d'un_chantier_--_2023_--_Le_Moniteur.epub-0229-00.png]]
