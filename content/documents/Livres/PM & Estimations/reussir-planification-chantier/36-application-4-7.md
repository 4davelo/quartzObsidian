...
section_id: "section:4.11"
ordre_document: 36
titre: "Application 4-7"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 36 Application 4-7
resume_section: |-
  **Résumé :**
  
  L'application 4-7 analyse la rotation de camions pour évacuer 4 000 m³ de déblais d'un chantier. Les calculs incluent :
  
  1. **Durée d'un cycle de camion** : 70 minutes (11 min chargement, 30 min transport chargé, 5 min déchargement, 24 min transport à vide).
  2. **Nombre de camions nécessaires** :
     - 6 camions : chargeur attend 4 min par cycle.
     - 7 camions : chargeur utilisé à 100 %, camions attendent.
  3. **Durée du chantier** :
     - Volume à transporter : 4 800 m³ (foisonnement 1,2).
     - Capacité totale : 6 camions × 9 m³ = 54 m³ par rotation.
     - 90 rotations nécessaires, soit 105 heures (15 jours à 7 h/jour).
...
section_precedente: "[[35-application-4-6|Application 4-6]]"
section_suivante: "[[37-planification-des-ressources|Planification des ressources]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["36_4.11_application_4-7.md"]
created: 2026-04-30
updated: 2026-04-30
