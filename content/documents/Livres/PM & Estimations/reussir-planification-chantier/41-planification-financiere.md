...
ordre_document: 41
titre: "Planification financière"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 41 Planification financière
resume_section: |-
  ## 5.4 Planification financière
  
  L’entreprise établit un prix sec (matériaux, matériels, main-d’œuvre) puis un prix d’offre incluant frais, bénéfices, aléas et TVA. Avant les travaux, elle planifie dépenses et recettes pour créer un diagramme financier. Ce dernier, basé sur des prévisions mensuelles (main-d’œuvre, matériaux, matériels, frais généraux), permet de gérer la trésorerie et de suivre les paiements, souvent liés à l’avancement mensuel des travaux.
  
  Le diagramme financier combine histogrammes et courbes cumulées des dépenses et recettes, facilitant le contrôle budgétaire. Une courbe en « S » illustre l’état d’avancement économique du projet, comparant prévisions et dépenses réelles. Les écarts entre ces courbes permettent des ajustements.
...
section_precedente: "[[40-planification-d-utilisation-du-materiel-et-des-engins|Planification d’utilisation du matériel et des engins]]"
section_suivante: "[[42-application-5-1|Application 5-1]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["41_5.4_planification_financière.md"]
created: 2026-04-30
updated: 2026-04-30
