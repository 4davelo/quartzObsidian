...
ordre_document: 5
titre: "Les parties prenantes d’un projet"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 5 Les parties prenantes d’un projet
resume_section: |-
  Les parties prenantes d’un projet incluent le maître d’ouvrage, le maître d’œuvre, les bureaux d’études techniques, les bureaux de contrôle et les entreprises.
  
  - **Maître d’ouvrage** : Commanditaire des travaux, il conclut des contrats avec les professionnels et rémunère leurs prestations.
  - **Maître d’œuvre** : Responsable de la conception et de la supervision des travaux, il veille au respect des plans, des réglementations et des conditions du marché.
  - **Bureau d’études techniques (BET)** : Réalise des études spécialisées (structure, équipements, etc.), élabore plans et notes de calcul, et suit l’exécution.
  - **Bureau de contrôle** : Prévention des risques techniques, avis sur la solidité, la sécurité et le fonctionnement des ouvrages, sous contrat avec le maître d’ouvrage.
  - **Entreprises** : Exécutent les travaux selon les prescriptions contractuelles, sous la direction du maître d’œuvre, avec des obligations de qualité et de respect des délais.
  
  Les relations entre ces intervenants sont régies par des contrats et des responsabilités mutuelles.
...
section_precedente: "[[04-definition-d-un-projet|Définition d’un projet]]"
section_suivante: "[[06-le-cycle-de-vie-d-un-projet-de-construction|Le cycle de vie d’un projet de construction]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["05_1.3_les_parties_prenantes_dun_projet.md"]
created: 2026-04-30
updated: 2026-04-30
