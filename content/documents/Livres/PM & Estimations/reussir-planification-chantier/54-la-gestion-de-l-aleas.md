...
section_id: "section:6.11"
ordre_document: 54
titre: "La gestion de l’aléas"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 54 La gestion de l’aléas
resume_section: |-
  ### 6.11 La gestion de l’aléa
  
  La gestion des aléas est essentielle en Lean Construction pour garantir qualité, coût et délai. Elle implique d’anticiper les imprévus, souvent négligés, entraînant des révisions fréquentes des plannings.
  
  **Revue des risques** : Réunion collaborative en amont (maîtrise d’ouvrage, maîtrise d’œuvre, OPC, CSPS, bureau de contrôle) pour identifier les risques, les classer sur une matrice et définir un plan d’actions avec responsables.
  
  **Anticipation de l’exécution** : Élaboration d’un planning rétroactif à partir des dates de pose des matériaux, permettant de planifier les actions nécessaires et fixer des échéances.
  
  **Marge pour aléas** : Prévoir une marge de 10 % du temps des travaux (environ une demi-journée par semaine) pour absorber les imprévus, avec des optimisations pour dégager cette marge.
...
section_precedente: "[[53-application-6-4|Application 6-4]]"
section_suivante: "[[55-les-optimisations|Les optimisations]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["54_6.11_la_gestion_de_laléas.md"]
created: 2026-04-30
updated: 2026-04-30
