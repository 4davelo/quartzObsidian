...
ordre_document: 40
titre: "Planification d’utilisation du matériel et des engins"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 40 Planification d’utilisation du matériel et des engins
resume_section: |-
  **5.3 Planification d’utilisation du matériel et des engins**
  
  **Détermination des besoins en matériels**
  Les besoins sont définis selon le mode de construction, les quantités issues de l’avant-métré et les caractéristiques du matériel. Étapes :
  - Identifier les quantités de travail à partir de l’avant-métré.
  - Déterminer les caractéristiques et durées d’utilisation des matériels.
  - Vérifier la disponibilité dans le parc ou définir les besoins en location (type, rendement, nombre).
  - Réserver et planifier le matériel selon l’avancement des travaux.
  - Identifier les consommables nécessaires et évaluer les coûts d’utilisation.
  
  **Planning d’utilisation du matériel**
  Le planning suit celui des tâches élémentaires et précise le type et le nombre de matériels nécessaires par tâche. Objectifs :
  - Vérifier la disponibilité ou la possibilité de location.
  - Comparer les coûts réels (amortissement/location) au budget alloué.
  
  Un exemple de planning est présenté (figure 5.2), indiquant matériels en ligne, dates en colonne, et quantités par tâche.
...
section_precedente: "[[39-planification-des-materiaux|Planification des matériaux]]"
section_suivante: "[[41-planification-financiere|Planification financière]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["40_5.3_planification_dutilisation_du_matériel_et_des_engins.md"]
created: 2026-04-30
updated: 2026-04-30
