...
titre: "Planification"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 10 Planification
resume_section: |-
  La planification de projet consiste à organiser et ordonnancer les tâches, tout en optimisant l’utilisation des ressources humaines, matérielles et financières. Elle vise à anticiper les délais, suivre l’avancement et gérer les ressources. Les documents nécessaires incluent plans d’exécution, CCAP, CCTP, notice descriptive et devis.
  
  Trois types de plannings sont élaborés selon les phases et niveaux de détail :
  - **Planning général** : établi par le maître d’œuvre, il fixe les dates clés des lots et la durée globale du projet (unité : mois).
  - **Planning détaillé** : décompose les lots en tâches, sert au suivi et au paiement des travaux (unité : semaine/jour).
  - **Planning d’exécution** : outil de pilotage pour l’entreprise, précisant les programmes de main-d’œuvre, matériel, approvisionnement et gestion budgétaire.
  
  Des plannings spécifiques sont également élaborés :
  - **Approvisionnement en matériaux** : quantités nécessaires par tâche et contrôle des consommations.
  - **Utilisation et rotation des matériels** : optimisation des équipements (ex. coffrages).
  - **Main-d’œuvre** : affectation optimale selon les besoins et courbe effectif-temps.
  - **Gestion budgétaire** : prévisions mensuelles des dépenses/recettes et courbes financières.
  - **Production** : cycles répétitifs visualisés via plannings type chemin de fer.
...
section_precedente: "[[09-organisation-et-gestion-de-chantier|Organisation et gestion de chantier]]"
section_suivante: "[[11-differentes-techniques-de-planification|Différentes techniques de planification]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["10_2.3_planification.md"]
created: 2026-04-30
updated: 2026-04-30
...
|||<br>**_planifcation_**|||
|---|---|---|---|---|
|**Type**|**Stade**<br>**d’élaboration**|**Auteur**|**Utilité**|**Documents**<br>**ressources**|
|**Planning**<br>**général**<br>**TCE**|_Étude du projet_|_Maître d’œuvre_|_Date de début et_<br>_fn de chaque lot_|_Programme_|
|**Planning**<br>**détaillé**|_Préparation de_<br>_chantier_|_Maître d’œuvre_<br>_aidé si possible_<br>_par le conducteur_<br>_de chaque lot_|_Suivi et paiement_<br>_des travaux_|_Planning général_<br>_TCE et dossier du_<br>_marché des_<br>_travaux_|

|**Planning**<br>**d’exécution**|_Étude d’exécution_|_Entreprise par son_<br>_conducteur des_<br>_travaux, aidé si_<br>_possible par le_<br>_chef de chantier_|_Exécution des_<br>_travaux_|
|---|---|---|---|
|||||
|||||
|||||
