...
section_id: "0007"
ordre_document: 43
titre: "Planification d’un chantier en Lean Construction"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 43 Planification d’un chantier en Lean Construction
resume_section: |-
  Le Lean Construction, inspiré du Lean Management (TPS), vise à optimiser les projets de construction en réduisant les gaspillages, en planifiant et anticipant systématiquement, en favorisant la collaboration et en recherchant l'amélioration continue. Centrée sur la satisfaction client (qualité, coût, délai), cette méthode privilégie une gestion pragmatique et rigoureuse sans dépendre d'outils complexes. De plus en plus adoptée, elle met l'accent sur la préparation en amont pour éviter erreurs et retards, garantissant ainsi l'excellence opérationnelle et l'apprentissage rapide des projets.
...
section_precedente: "[[42-application-5-1|Application 5-1]]"
section_suivante: "[[44-la-planification-globale-en-chemin-de-fer|La planification globale en chemin de fer]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["43_chapitre_6_-_planification_dun_chantier_en_lean_construction.md"]
created: 2026-04-30
updated: 2026-04-30
