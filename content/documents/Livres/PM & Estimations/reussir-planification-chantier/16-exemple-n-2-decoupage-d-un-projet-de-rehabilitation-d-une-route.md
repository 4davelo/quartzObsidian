...
ordre_document: 16
titre: "Exemple n° 2 : Découpage d’un projet de réhabilitation d’une route"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 16 Exemple n° 2 : Découpage d’un projet de réhabilitation d’une route
resume_section: |-
  Exemple de découpage d’un projet de réhabilitation d’une route :
  Le projet (niveau 1) est structuré en six corps d’état (niveau 2), chacun subdivisé en tâches spécifiques (niveau 3). Par exemple :
  - **Installation de chantier** : levés topographiques, dégagement des emprises, débroussaillage.
  - **Terrassements généraux** : déblais meubles, décaissement, remblais.
  - **Travaux de chaussée** : couches de fondation, base, roulement, revêtements.
  - **Ouvrages de drainage** : fossés, dalots, conduites, coffrages, murs para-fouille.
  - **Signalisation** et **finitions**.
  
  L’organigramme WBS et le tableau détaillent ces étapes.
...
section_precedente: "[[15-exemple-n-1-decoupage-d-un-projet-de-construction-d-un-hopital|Exemple n° 1 : Découpage d’un projet de construction d’un hôpital]]"
section_suivante: "[[17-calcul-des-durees-d-execution-des-taches|Calcul des durées d’exécution des tâches]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["16_3.4_exemple_n_2_découpage_dun_projet_de_réhabilitation_dune_route.md"]
created: 2026-04-30
updated: 2026-04-30
...
||<br>**_réhabilitation d’une route_**||
|---|---|---|
|**Code**|**Désignation**|**Niveau**|
|**_0_**|**_Projet de réhabilitation d’une_**<br>**_route_**|**_1_**|
|_1_|_Installation de chantier_|_2_|
|_1.1_|_Levés topographiques et étude_<br>_d’exécution_|_3_|
|_1.2_|_Dégagement des emprises_|_3_|
|_1.3_|_Débroussaillage et décapage_<br>_dans l’emprise des travaux_|_3_|
...
|_3.1_|_Couche de fondation en_<br>_GC0/31,5 sur remblai_|_3_|
|_[3.2](14_3.2_découpage_du_projet.md)_|_Couche de base en GC0/20_<br>_+ Finition_|_3_|
|_[3.3](15_3.3_exemple_n_1_découpage_dun_projet_de_construction_dun_hôpital.md)_|_Accotements en TV0/40_|_3_|
|_3.4_|_Fourniture et mise en œuvre_<br>_d’une couche d’accrochage_|_3_|
|_3.5_|_Fourniture et mise en œuvre_<br>_d’une couche d’imprégnation_<br>_sablée_|_3_|
|_3.6_|_Couche de roulement en BB_<br>_0/14_|_3_|
|_3.7_|_Revêtement superfciel en_<br>_bicouche_|_3_|

|_4_|_Ouvrages de drainage_|_2_|
|---|---|---|
|_4.1_|_Fossés en terre_|_3_|
|_4.2_|_Fossé trapézoïdal bétonné_|_3_|
|_4.3_|_Fourniture, transport et pose de_<br>_conduite Ø 800_|_3_|
|_4.4_|_Ouvrage de tête pour buse en_<br>_béton armé Ø 800_|_3_|
|_4.5_|_OH9 dalot 4(2,00 x1,50)_|_3_|
|_4.6_|_OA4 Cassis 100 ml_|_3_|
|_4.7_|_Dalot 25 x (2,00 x1,00)_|_3_|
|_4.8_|_Fouille + coulage béton de_<br>_propreté_|_3_|
|_4.9_|_Cofrage, Ferraillage, Coulage_<br>_du radier_|_3_|
|_4.10_|_Cofrage, Ferraillage, Coulage_<br>_voile_|_3_|
|_4.11_|_Cofrage, Ferraillage, Coulage_<br>_traverse_|_3_|
|_4.12_|_OH2 Dalot 2x (2,00x1,50)_|_3_|
|_4.13_|_OD2 Dalot (2,00x1,00)_|_3_|
|_4.14_|_OD1 Dalot (1,00x1,00)_|_3_|
|_4.13_|_Cofrage, Ferraillage, Coulage_<br>_voile_|_3_|
|_4.14_|_Cofrage, Ferraillage, Coulage_<br>_traverse_|_3_|
