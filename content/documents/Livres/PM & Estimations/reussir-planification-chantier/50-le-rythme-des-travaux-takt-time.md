...
ordre_document: 50
titre: "Le rythme des travaux (takt time )"
aliases:
  - Réussir la planification d'un chantier — Le Moniteur 2023 — 50 Le rythme des travaux (takt time )
resume_section: |-
  Le *takt time* représente le rythme de production nécessaire pour répondre à la demande client, essentiel en Lean Construction. Il se calcule principalement pour les travaux intérieurs impliquant des zones répétitives et divers acteurs. La formule est :
  
  **Takt time = (Durée disponible − Durée de la séquence) ÷ (Nombre de zones − 1)**
  
  Un *takt time* élevé allonge la durée globale des travaux, car il réduit la cadence. L’objectif est d’ajuster ce rythme pour respecter les délais clients. La durée d’une séquence travaux a un impact limité sur la durée totale, contrairement à la coordination entre zones. Une mauvaise synchronisation entraîne des temps morts et des retards.
...
section_precedente: "[[49-application-6-2|Application 6-2]]"
section_suivante: "[[51-application-6-3|Application 6-3]]"
tags: [document-section, ouvrage, gestion-projet, planification, estimation]
sources: ["50_6.7_le_rythme_des_travaux_takt_time.md"]
created: 2026-04-30
updated: 2026-04-30
...
Takt time=Durée disponible−Durée de la séquenceNombre de zone−1 

**Avec :** 

Durée disponible : nombre de jours disponibles pour réaliser les travaux. Durée de la séquence : nombre de jours de la séquence travaux réalisée avec les entreprises. Nombre de zones : nombre de zones répétitives pour cette séquence de travaux.

Le calcul du takt time est nécessaire pour comprendre le décalage en jours de la séquence travaux entre les différentes zones répétitives (voir **fg. 6.23** ). 
...
**Rapport entre durée de la séquence travaux et le takt time** 

Malgré ce que l’on peut penser, la durée de la séquence travaux a un impact faible sur la durée globale des travaux. Par exemple, une séquence plus longue de 2 jours entraînera un décalage de 2 jours de la date de fin, qu’importe le nombre de zones (voir **fg. 6.24** ). 
