...
section_id: "section:51.6"
ordre_document: 344
titre: "51.6 Structures"
aliases: ["La Technique du bâtiment – Tous corps d’état — 344 51.6 Structures"]
resume_section: |-
  **51.6 Structures**

  Les structures photovoltaïques, supports des modules, varient selon les projets (habitat, bâtiments industriels, etc.) et objectifs architecturaux (toiture, façade). Elles se divisent en :
  - **Structures monofonctionnelles** : modules sur toiture sans fonction d’étanchéité.
  - **Structures multifonctionnelles** : production d’énergie et fonctions constructives (étanchéité, isolation, etc.).
  - **Structures de protection solaire** : en toiture ou façade.
  - **Structures triangulées au sol**.

  Les critères d’intégration au bâti ou d’intégration simplifiée, définis par l’arrêté du 4 mars 2011, influent sur les tarifs d’achat de l’électricité. L’intégration au bâti exige que les modules remplacent des éléments de toiture et assurent l’étanchéité. L’intégration simplifiée impose des conditions similaires, mais avec des fonctions secondaires possibles (bardage, brise-soleil, etc.).

  **Exemples de structures** :
  - **S-TE Integra** : structure en aluminium pour toitures en tuiles ou ardoises, adaptée aux pentes ≥ 15°.
  - **S-TE Integra Max** : pour bâtiments industriels/agricoles, compatible avec des pentes de 5 à 50°, combinant modules photovoltaïques et étanchéité.
  - **51.6.1 Principales familles de structures** — `section:51.6.1`, heading, profondeur 5, pages 1931-1932
  - **51.6.2 Exemples de structures** — `section:51.6.2`, heading, profondeur 5, pages 1933-1934
...
section_precedente: "[[documents/Livres/BTP/la-technique-du-batiment-tous-corps-detat/343-51-5-de-la-cellule-au-module-photovoltaique|51.5 De la cellule au module photovoltaïque]]"
section_suivante: "[[documents/Livres/BTP/la-technique-du-batiment-tous-corps-detat/345-51-7-utilisation-de-l-energie-photovoltaique|51.7 Utilisation de l’énergie photovoltaïque]]"
tags: [document-section, ouvrage, btp, tous-corps-detat]
sources: [344_51.6_structures.md]
created: 2026-04-29
updated: 2026-04-29
...
**51.6.1 Principales familles de structures** 

On désigne par ce terme les éléments sur lesquels reposent les modules. Dans les parcs photovoltaïques (centrales au sol), les modules sont fixés sur des structures métalliques dont la hauteur et l’inclinaison sont spécifiquement calculées par rapport à l’ensoleillement et à l’orientation du parc, afin de maximiser le rendement de l’installation. 

Aujourd’hui, les modes d’intégration des modules photovoltaïques sont extrêmement divers selon le type de projet (habitat individuel, bâtiments collectifs, sites industriels, parkings…) et les objectifs architecturaux poursuivis (façade, toiture ou autres). 

Les types de structures sont par conséquent tout aussi nombreux, et la recherche continue à faire progresser les possibilités d’implantation. On peut approcher les principales familles de structures de façon fonctionnelle en distinguant : 

les structures monofonctionnelles de toiture de bâtiments : les modules photovoltaïques sont disposés sur une toiture en tuiles, en zinc ou autre, mais n’assurent aucune fonction de toiture, notamment d’étanchéité ; 

les structures multifonctionnelles qui assurent, en toiture ou en façade, à la fois la production d’énergie et une ou plusieurs fonctions d’élément de construction : étanchéité à l’eau, à l’air, protection, isolation thermique, isolement acoustique, etc. ; les structures qui assurent une fonction de protection solaire, en toiture ou en façade ; les structures triangulées au sol. 

Cette approche fonctionnelle correspond à différents tarifs de rachat de l’électricité produite, les solutions dites « intégrées au bâti » bénéficiant de tarifs supérieurs aux solutions « avec intégration simplifiée au bâti ». 

Pour ces questions, on se reportera notamment à l’arrêté du 4 mars 2011. Il précise notamment dans son annexe 2, les critères d’intégration et d’intégration simplifiée.
...
5.2. À l’exception des parties où le recouvrement est techniquement impossible, l’installation photovoltaïque protège l’ensemble du bâtiment du soleil et est étanche à l’eau. 
...
Bien entendu, l’offre de produits et de services s’adapte aux différents tarifs fixés par la réglementation. 

**51.6.2 Exemples de structures** 

On trouvera ci-après deux exemples de structures adaptées : le premier concerne la maison individuelle ; le second, un bâtiment industriel ou agricole. 
...
![](images/La_Technique_du_bâtiment_-_Tous_corps_d’état_--_Cécile_Granier_&_Michel_Platzer_&_Daniel_Montharry_--_2024_--_Le_Moniteur.epub-1934-00.png)
...
![](images/La_Technique_du_bâtiment_-_Tous_corps_d’état_--_Cécile_Granier_&_Michel_Platzer_&_Daniel_Montharry_--_2024_--_Le_Moniteur.epub-1935-00.png)
