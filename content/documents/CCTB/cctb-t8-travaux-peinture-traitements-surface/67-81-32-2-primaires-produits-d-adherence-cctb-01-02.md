...
section_id: "section:81.32.2"
ordre_document: 67
titre: "81.32.2 Primaires / produits d'adhérence CCTB 01.02"
aliases: [CCTB T8 — Travaux de peinture / Traitements de surface 01.13 — 67 81.32.2 Primaires / produits d'adhérence CCTB 01.02]
resume_section: |-
  **81.32.2 Primaires / produits d'adhérence CCTB 01.02**

  **Description :** Prescriptions pour systèmes de peinture primaire sur supports métalliques non ferreux (acier zingué, cuivre, aluminium), incluant la préparation du subjectile.

  **Matériaux :**
  - **Acrylique :** Résine acrylique en solution, phase aqueuse, application entre 5-35 °C, humidité ≤ 75 %, densité ≥ 1,2, extrait sec ≥ 45 % (poids).
  - **Époxy :** Résine époxy à deux composants, application entre 10-35 °C, humidité ≤ 75 %, densité ≥ 1,4, extrait sec ≥ 60 % (poids).
  - COV : ≤ 500 g/l (UE).

  **Exécution :**
  - Conditions : Température ≥ 10 °C, humidité ≤ 75 %, absence de condensation.
  - Préparation : Nettoyage, dégraissage, ponçage selon articles 81.32.1a/b/c.
  - Application : Couche de fond et retouches selon NIT 249.
  - Catégories de corrosivité (intérieur) : C1/C2 (par défaut) à C5-I/M.
  - Épaisseur minimale : ≥ 60/80 μm.

  **Références :**
  - NIT 249 : Guide pour travaux de peinture.
  - NBN EN ISO 12944-2 : Classification des environnements corrosifs.

  **Mesurage :** Inclus dans les prix unitaires des profilés.
  - **81.32.2a Primaires / produits d'adhérence intérieurs sur supports métalliques non ferreux CCTB 01.12** — `section:81.32.2a`, article, profondeur 6, pages 216-217
...
section_precedente: "[[documents/CCTB/cctb-t8-travaux-peinture-traitements-surface/66-81-32-1-nettoyage-degraissage-poncage-cctb-01-02|81.32.1 Nettoyage / Dégraissage / Ponçage CCTB 01.02]]"
section_suivante: "[[documents/CCTB/cctb-t8-travaux-peinture-traitements-surface/68-81-32-3-reparations-par-enduits-esthetiques-des-surfaces-cctb-01-02|81.32.3 Réparations par enduits esthétiques des surfaces CCTB 01.02]]"
tags: [document-section, cctb]
sources: [67_81.32.2_primaires_produits_dadhérence_cctb_01.02.md]
created: 2026-04-28
updated: 2026-04-28
