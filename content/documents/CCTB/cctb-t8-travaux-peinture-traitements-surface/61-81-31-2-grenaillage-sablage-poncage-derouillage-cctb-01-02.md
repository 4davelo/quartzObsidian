...
section_id: "section:81.31.2"
ordre_document: 61
titre: "81.31.2 Grenaillage Sablage / Ponçage / Dérouillage CCTB 01.02"
aliases: [CCTB T8 — Travaux de peinture / Traitements de surface 01.13 — 61 81.31.2 Grenaillage Sablage / Ponçage / Dérouillage CCTB 01.02]
resume_section: |-
  **81.31.2 Grenaillage - Sablage / Ponçage / Dérouillage CCTB 01.02**

  ### **Grenaillage - Sablage intérieur sur supports métalliques ferreux**
  - **Objectif** : Décapage par projection d'abrasif pour préparer les supports métalliques ferreux avant peinture, selon [NBN EN ISO 8504-2].
  - **Abrasifs** : Conformes aux normes [NBN EN ISO 11124/11126], exempts de contaminants. Abrasifs recyclés ou issus de scories d'eau salée interdits.
  - **Exécution** :
    - Préparation : Nettoyage préalable (huile, graisse, sels) et élimination des couches épaisses de rouille.
    - Techniques : Sablage à sec ou humide, choix de l'abrasif et essais préliminaires recommandés.
    - Degré de préparation : Sa 2,5 (peinture) ou Sa 3 (métallisation) selon [NBN EN ISO 12944-4] et [NBN EN ISO 8501-1].
    - Nettoyage post-sablage : Méthode adaptée (aspiration, lavage, séchage).
  - **Contrôles** : Conformité évaluée selon [NBN EN ISO 8501-1/2]. Non-conformité entraîne répétition.

  ### **Ponçage - Dérouillage intérieur sur supports métalliques ferreux**
  - **Objectif** : Préparation manuelle ou mécanique des supports métalliques ferreux avant peinture, selon [NBN EN ISO 8504-3].
  - **Exécution** :
    - Préparation : Nettoyage préalable (huile, graisse, sels) et masquage des zones non traitées.
    - Techniques : Ponçage manuel (outils manuels) ou mécanique (outils électriques/pneumatiques). Attention à ne pas polir ou rendre les surfaces trop rugueuses.
    - Degré de préparation : St 2,5 (par défaut) ou St 3 selon [NBN EN ISO 12944-4] et [NBN EN ISO 8501-1].
    - Nettoyage post-traitement : Élimination des résidus par aspiration, lavage et séchage.
  - **Contrôles** : Conformité évaluée selon [NBN EN ISO 8501-1/2]. Non-conformité entraîne répétition.

  ### **Références normatives principales**
  - [NBN EN ISO 8501-1/2/3], [NBN EN ISO 8504-2/3], [NBN EN ISO 12944-4], [NBN EN ISO 8503-1].

  ### **Mesurage**
  - Inclus dans les prix unitaires des profilés à traiter.
  - **81.31.2a Grenaillage - sablage intérieur sur supports métalliques ferreux CCTB 01.11** — `section:81.31.2a`, article, profondeur 6, pages 195-198
  - **81.31.2b Ponçage - dérouillage intérieur sur supports métalliques ferreux CCTB 01.10** — `section:81.31.2b`, article, profondeur 6, pages 199-201
...
section_precedente: "[[documents/CCTB/cctb-t8-travaux-peinture-traitements-surface/60-81-31-1-nettoyage-degraissage-cctb-01-10|81.31.1 Nettoyage / Dégraissage CCTB 01.10]]"
section_suivante: "[[documents/CCTB/cctb-t8-travaux-peinture-traitements-surface/62-81-31-3-protections-de-surface-cctb-01-10|81.31.3 Protections de surface CCTB 01.10]]"
tags: [document-section, cctb]
sources: [61_81.31.2_grenaillage_-_sablage_ponçage_dérouillage_cctb_01.02.md]
created: 2026-04-28
updated: 2026-04-28
