...
section_id: "section:53.55"
ordre_document: 261
titre: "53.55 Revêtements de sols souples CCTB 01.12"
aliases: [CCTB T5 — Fermetures / Finitions intérieures 01.13 — 261 53.55 Revêtements de sols souples CCTB 01.12]
resume_section: |-
  **53.55 Revêtements de sols souples CCTB 01.12**

  **Description**
  Fourniture et pose de revêtements de sol souples (résilients ou textiles) en lés ou dalles sur supports rigides adaptés. Comprend préparation du support, contrôle d'humidité, égalisation, collage, soudure des joints, nettoyage final. Les matériaux peuvent être neufs ou de réemploi, conformes aux normes [NBN EN ISO 10874].

  **Matériaux**
  Classes d'usage selon les locaux (habitation, commerce, usage intensif). Les matériaux de réemploi sont autorisés pour des usages similaires ou moins contraignants. Uniformité de couleur garantie par lot. Stockage et acclimatation des rouleaux selon [NIT 241] et [NIT 262]. Respect des exigences de sécurité incendie.

  **Mise en œuvre**
  Pose selon [NIT 241] (résilients) et [NIT 262] (textiles). Préparation du support : nettoyage, réparation, égalisation, application de primaires adaptés. Contrôle du taux d'humidité selon méthode CM. Collage des lés/dalles après acclimatation, en respectant les orientations et recommandations des normes. Nettoyage final obligatoire.

  **Contrôles**
  Aucune différence de hauteur, bulles ou bords non adhérents tolérés.

  **Références normatives**
  [NBN EN 12466], [NBN EN ISO 10874], [NIT 241], [NIT 262], etc.
...
section_precedente: "[[documents/CCTB/cctb-t5-fermetures-finitions-interieures/260-53-54-2-revetements-en-carreaux-a-base-de-liants-resineux-cctb-01-02|53.54.2 Revêtements en carreaux à base de liants résineux CCTB 01.02]]"
section_suivante: "[[documents/CCTB/cctb-t5-fermetures-finitions-interieures/262-53-55-1-revetements-de-sols-souples-en-textile-cctb-01-02|53.55.1 Revêtements de sols souples en textile CCTB 01.02]]"
tags: [document-section, cctb]
sources: [261_53.55_revêtements_de_sols_souples_cctb_01.12.md]
created: 2026-04-28
updated: 2026-04-28
...
|**Composition du sol**|**Temps de séchage**|**Humidité de compensation**<br>**admissible en CM -%**|
|---|---|---|
...
|Chape magnésite (sans matière<br>de charge à base de bois)|3

- 4 semaines selon l'épaisseur|≤ 3 %|
|Chape magnésite (avec matière<br>de charge à base de bois)|1
