...
ordre_document: 498
titre: "24 Superstructures en bois CCTB 01.13"
aliases: [CCTB T2 — Superstructures 01.13 — 498 24 Superstructures en bois CCTB 01.13]
resume_section: |-
  **Résumé du segment : 24 Superstructures en bois CCTB 01.13**

  Ce segment détaille les exigences techniques et normatives pour les superstructures en bois, incluant la conception, la fabrication, la mise en œuvre et les contrôles. Les éléments en bois doivent respecter des normes spécifiques (NBN EN, STS, Eurocodes) selon leur type (bois massif, lamellé-collé, CLT, LVL, etc.) et leur usage (classes d’emploi 1 à 5). Les matériaux doivent provenir de forêts gérées durablement, et les colles utilisées doivent être conformes aux normes applicables. La durabilité naturelle ou conférée des bois est essentielle, avec des traitements de préservation requis selon les classes d’emploi.

  Les tolérances dimensionnelles, la maîtrise de l’humidité, les assemblages (mécaniques ou collés) et les protections contre les intempéries sont strictement encadrés. Les exigences de réaction et de résistance au feu sont définies par des essais ou calculs conformes aux normes. Les éléments doivent être livrés, stockés et montés dans des conditions garantissant leur intégrité. Enfin, des critères de recyclage et de réutilisation sont inclus, ainsi que des prescriptions pour le contrôle qualité et la documentation technique.
document_parent: "[[documents/CCTB/cctb-t2-superstructures/index|CCTB T2 — Superstructures 01.13 — Index]]"
section_precedente: "[[documents/CCTB/cctb-t2-superstructures/497-23-88-traitements-et-protections-cctb-01-04|23.88 Traitements et protections CCTB 01.04]]"
section_suivante: "[[documents/CCTB/cctb-t2-superstructures/499-24-1-elements-de-structures-en-bois-cctb-01-13|24.1 Eléments de structures en bois CCTB 01.13]]"
tags: [document-section, cctb]
sources: [498_24_superstructures_en_bois_cctb_01.13.md]
created: 2026-04-28
updated: 2026-04-28
...
### 24 [[concepts/superstructures|Superstructures]] en bois [[entities/cctb|CCTB]] 01.13
...
- le dressage et la fourniture des plans d'exécution à établir par l’entrepreneur et pour approbation par le maître de l’ouvrage ; 

- la fabrication et la fourniture des éléments telles que définies sur les plans avec pentes, courbures, cintrages, façonnages (découpes et entailles, forages et pré forages, défonçages), ferrures, sabots, connecteurs (vis, tirefonds, boulons, broches, crampons, rondelles, etc.), colles, bouchons, tiges filetées, organes métalliques divers, accessoires éventuels, scellements, ancrages, remplissages, calages, etc. ; 

- la préservation ; 

- la préparation des surfaces, les traitements et produits de finition (essais et nombre de couches nécessaires) ; 

- les échantillons demandés par le maître de l’ouvrage ; 

- la réalisation de toutes les réservations et ouvertures ; 

- la pose des éléments avec leur mise à niveau et le montage (assemblages, etc.) ; 

- la protection face aux intempéries lors du transport, stockage et montage jusqu’à la protection définitive des éléments en bois ;

- toute sujétion relative aux travaux décrits. 

**MATÉRIAUX** 

**PRODUCTION DES ELEMENT **S** 
...
- la [NBN EN 301], concernant les adhésifs de nature phénolique et aminoplaste ; 

- la [NBN EN 15425], concernant les adhésifs polyuréthane monocomposants ; 

- la [NBN EN 16254:2013+A1], concernant les adhésifs isocyanate polymérisé en émulsion (EPI) ; 

- la [NBN EN 12436], concernant les adhésifs à base de caséine. 

Pour les usages non structuraux : 

- la [NBN EN 204], concernant les colles thermoplastiques ; 

- la [NBN EN 12765], concernant les colles thermodurcissables. 
...
A moins que des tolérances plus strictes ne soient précisées dans le cahier spécial des charges, tous les éléments structuraux en bois massif, aboutés ou non, satisfont à la classe de tolérance [2](04_2_t2_superstructures_cctb_01.13.md) de la [NBN EN 336] et à la [NBN EN 1313 série]. 
...
|**Classe d'emploi**|**Classe d'emploi**|**Conditions**|**Exemple**||**Risques**|**Risques**||
|---|---|---|---|---|---|---|---|
|||||**Champi**<br>**gnons**|**Insectes**||**Térébrants**<br>**marins**|
||||||**à**<br>**larves**<br>**xyloph**<br>**ages**|**Termites**||
|**Classe 1**||Bois situé à<br>l'intérieur, pas<br>d'humidification<br>possible|Charpente<br>apparente,<br>plancher, escalier<br>intérieur|Non|Oui|Localement|Non|
|**Classe [2](04_2_t2_superstructures_cctb_01.13.md)**||Bois abrité des<br>intempéries. Des<br>humidifications<br>sontpossibles|Charpente non-<br>apparente|Oui|Oui|Localement|Non|
|**Classe**<br>**3**|**Classe**<br>**3-1**|Bois soumis aux<br>intempéries. Pas<br>d'accumulation<br>d'eau.|Bardage, poteau<br>extérieur sans<br>contact avec le<br>sol|Oui|Oui|Localement|Non|
||**Classe**<br>**3-[2](04_2_t2_superstructures_cctb_01.13.md)**|Bois soumis aux<br>intempéries.<br>Accumulation<br>d'eaupossible.|Lame de terrasse,<br>poutre extérieure|Oui|Oui|Localement|Non|
|**Classe 4**||bois en contact<br>direct avec le sol<br>et/ou avec de<br>l'eau douce|Poteau en contact<br>avec le sol|Oui|Oui|Localement|Non|
|**Classe 5**||Bois en contact<br>direct avec de|Ponton Maritime|Oui|Oui|Localement|Oui|
...
|---|---|
|Charpente|[2](04_2_t2_superstructures_cctb_01.13.md)|
|Semelle d'assise|3|
|Montant et traverses de l'ossature|[2](04_2_t2_superstructures_cctb_01.13.md)|
|Solivespourplancher|1|
|Dalle bois<br>Les bois doivent avoir une durabilité naturelle ou conférée correspondant à une<br>classe d'emploi 3|3|
|Bardage extérieur|3b|
|Lattagepour bardage|3a|
...
- vis-à-vis du risque lié aux champignons, sur 5 niveaux : de 1 (très durable) à 5 (non durable) ; 

- vis-à-vis du risque lié aux attaques d’insectes à larves xylophages, sur [2](04_2_t2_superstructures_cctb_01.13.md) niveaux : D (durable) ou S (non durable) ; 

- vis-à-vis du risque lié aux termites, sur trois niveaux : D (durable), M (moyennement durable) ou S (non durable) ; 

- vis-à-vis du risque lié aux térébrants marins, sur trois niveaux : D (durable), M (moyennement durable) ou S (non durable) ;
...
|**Classe**<br>|**Classe de durabilité naturelle vis-vis des attaques de champignons lignivores**|**Classe de durabilité naturelle vis-vis des attaques de champignons lignivores**|**Classe de durabilité naturelle vis-vis des attaques de champignons lignivores**|**Classe de durabilité naturelle vis-vis des attaques de champignons lignivores**|**Classe de durabilité naturelle vis-vis des attaques de champignons lignivores**|
|---|---|---|---|---|---|
|**d'emploi**|**1**|**[2](04_2_t2_superstructures_cctb_01.13.md)**|**3**|**4**|**5**|
|||||||
|**1**|0|0|0|0|0|
|**[2](04_2_t2_superstructures_cctb_01.13.md)**|0|0|0|(0)|(0)|
|**3**|0|0|(0)|(0)-(x)|(0)-(x)|
|**4**|0|(0)|(x)|x|x|
|**5**|0|(x)|(x)|x|x|
|**Légende:**||||||
|0            durabilité naturelle suffisante(vis-à-vis des champignons lignivores)||||||
|(0)         durabilité naturelle normalement suffisante, mais pour certains emplois un traitement de<br>préservationpeut être recommandé(voir annexe A de[NBN EN 460])||||||
|(0)-(x)    la durabilité naturelle peut être suffisante, mais en fonction de l'essence de bois, de<br>sa  perméabilité (voir 6.1 de [NBN EN 460]) et de son emploi final (voir annexe A de [NBN EN 460]),<br>un traitement depréservationpeut s'avérer nécessaire||||||
|(x)         le traitement de préservation est normalement recommandé, mais pour certains emplois la<br>durabilité naturellepeut être suffisante(voir annexe A de[NBN EN 460])||||||
|x            traitement depréservation nécessaire||||||
...
Les traitements, protection et finition des bois sont décrits dans l'élément [24.7 Traitements, protection et finition des bois](571_24.7_traitements_protection_et_finition_des_bois_cctb_01.11.md) du présent cahier des charges et dans la [STS 04.3]. 
...
- éviter les attaques de champignons, 

- éviter les désordres liés aux mouvement (retrait-gonflement) du bois, 

- garantir des propriétés mécaniques conformes à celles attendues, 

- assurer la bonne adhésion des colles et des couches de finition. 
...
- étendue admissible de la teneur en humidité moyenne par rapport à la teneur en humidité cible ; 

- limites inférieure et supérieure de teneur en humidité admissible pour les pièces individuelles ; 
...
|Produit|Masse Volumique<br>minimale|Epaisseur minimale|Référence de la<br>décision européenne|
|---|---|---|---|
...
|CLT (épaisseur de<br>couche min. : 18mm)|350 kg/m³|54mm|C/2017/5389|
|---|---|---|---|
|LVL (épaisseur des<br>placages min. : 3mm)|400 kg/m³|18mm|C/2017/5389|
...
La performance de résistance au feu des éléments en bois et de ses assemblages doit être attestée soit par un rapport de classification selon la norme [NBN EN 13501-[2](04_2_t2_superstructures_cctb_01.13.md)], sur base d’un ou plusieurs essais en laboratoire, soit par un calcul selon la partie feu de l’Eurocode 5 ([NBN EN 1995-1-2] et son annexe nationale). 
...
- Les produits à base de bois massif qui comprennent les bois massifs, les bois massifs aboutés, les bois massifs reconstitués, les bois lamellés-collés, les bois lamellés-collés en bloc et les bois lamellés-croisés. 

- Les produits à base de placages qui comprennent les LVL, les PSL, les LSL et les panneaux contreplaqués. 

- Les produits issus de la trituration qui comprennent les panneaux OSB, les panneaux de particules et les panneaux MDF. 

- Les produits à sections recomposées du type poutres en I, etc. 
...
|<br>massifs est donnée dans le tableau ci-dessous :||
|---|---|
|Classe d’emploi|Teneur en humidité cible du bois|
|1|< 12%|
|[2](04_2_t2_superstructures_cctb_01.13.md)|< 17%|
|3|< 22%|
|4|> 25%|
|5||
...
Les bois massifs reconstitués sont compris dans les bois lamellés collés. Un bois massifs reconstitué est composé de [2](04_2_t2_superstructures_cctb_01.13.md) à 5 lamelles. Ces lamelles sont d’une épaisseur comprise entre 45mm et 85mm. 
...
- Durabilité des lamellés collés 

Il est préférable de concevoir avec du bois lamellé collé en privilégiant les classes d’emploi 1 et [2](04_2_t2_superstructures_cctb_01.13.md), mais une utilisation en classe d’emploi 3 ou 4 sera possible avec une étude au cas par cas et seulement sous conditions particulières. 
...
Il s’agit d’éléments de structure ayant une section transversale massive, fabriqué à partir d’au moins deux composants en bois lamellé-collé assemblés par collage à l'aide d'un adhésif pour joint épais. Les prescriptions pour le bois lamellé-collé sont d’application. 
...
Bien qu’elle comporte l’annexe ZA, il n’est pas possible d’effectuer le marquage CE sur base de celleci tant qu’elle n’a pas été publiée au journal officiel de l’union européenne. 
...
Il est conseillé de se limiter aux classes d’emploi 1 ou [2](04_2_t2_superstructures_cctb_01.13.md) pour le bois lamellé croisé. 
...
-Avec une humidité de bois de 12% (+/-[2](04_2_t2_superstructures_cctb_01.13.md)%), la largeur maximale du joint est de 4mm. Le choix de la largeur des lamelles appartient au fabricant. 
...
- Avec une humidité de bois de 12% (+/-[2](04_2_t2_superstructures_cctb_01.13.md)%), la largeur maximale du joint est de 2mm, 
...
- LVL/[2](04_2_t2_superstructures_cctb_01.13.md) pour usage en classe d’emploi 1 ou 2, 

- LVL/3 pour usage en classe d’emploi 1, [2](04_2_t2_superstructures_cctb_01.13.md) ou 3. 
...
Le PSL (Parralel Strand Lumber, bandes de bois parallèles) est un matériau à base de bandes de placages de bois relativement étroites et longues (jusqu’à 3x2400mm) disposées à fils parallèles, encollées et pressées. 
...
Tous les assemblages mécaniques structuraux sont dimensionnés selon les principes de l’Eurocode 5 [NBN EN 1995-1-1] et de sa partie feu [NBN EN 1995-1-[2](04_2_t2_superstructures_cctb_01.13.md)]. 

Les exigences de mises en œuvre dictées dans l’Eurocode 5, dans les autres normes européennes et/ou autres documents faisant référence (tel que NIT, STS ou équivalent) sont respectées, notamment en ce qui concerne la pénétration minimale dans la dernière pièce, le pré-perçage éventuel et les distances minimales à respecter. 
...
[NBN EN 313-[2](04_2_t2_superstructures_cctb_01.13.md), Contreplaqué

- Classification et terminologie

- Partie [2](04_2_t2_superstructures_cctb_01.13.md) : Terminologie] 
...
[NBN EN 460, Durabilité du bois et des matériaux dérivés du bois - Durabilité naturelle du bois massif 
...
- Essais des fermes pour la détermination de la résistance et de la rigidité] 
...
1 : Emission de formaldéhyde par la méthode à la chambre] 

[NBN EN 844, Bois rond et bois scié - Terminologie] 
...
- Partie 1: Epicéas, sapins, pins et Douglas Européens] 
...
- Panneaux surfacés mélaminés pour usages intérieurs
...
[NBN EN 16254:2013+A1, Adhésifs

- Isocyanate polymérisé en émulsion (EPI) pour structures portantes en bois
...
[Règlement (UE) 305/2011, Règlement du Parlement européen et du Conseil établissant des conditions harmonisées de commercialisation pour les produits de construction et abrogeant la directive 89/106/CEE du Conseil] 
...
|---|---|---|
|Charpente en bois massif|[2](04_2_t2_superstructures_cctb_01.13.md) ou 3|18%|
|Lamellé-collé|1 ou [2](04_2_t2_superstructures_cctb_01.13.md)|12%|
|CLT|1 ou [2](04_2_t2_superstructures_cctb_01.13.md)|12%|
|LVL|1 ou [2](04_2_t2_superstructures_cctb_01.13.md)|12%|
|Elément d'ossature bois|1 ou [2](04_2_t2_superstructures_cctb_01.13.md)|17%|
|Charpentepréfabriquée|[2](04_2_t2_superstructures_cctb_01.13.md) ou 3|20%|
...
- teneur en humidité d’équilibre moyenne dans l’ambiance, 

- type de bois (essence, bois massifs, bois massifs collés, …), 

- variation éventuelle des conditions d’ambiance (en fonction des saisons, de la finition du bois, de l’exposition, etc.), 

- éventuellement, période de mise en œuvre de l’élément. 
...
|**Classe d'emploi**|**Variationpotentielle**|
|---|---|
|1|6%

- 11%|
|[2](04_2_t2_superstructures_cctb_01.13.md)|6%
