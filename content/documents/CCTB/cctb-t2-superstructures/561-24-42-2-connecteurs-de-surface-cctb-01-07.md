...
section_id: "section:24.42.2"
ordre_document: 561
titre: "24.42.2 Connecteurs de surface CCTB 01.07"
aliases: [CCTB T2 — Superstructures 01.13 — 561 24.42.2 Connecteurs de surface CCTB 01.07]
resume_section: |-
  ### 24.42.2 Connecteurs de surface CCTB 01.07

  #### Tolérances et dimensions
  Les connecteurs de surface respectent des tolérances spécifiques selon les dimensions (longueur, largeur, diamètre, épaisseur) et les normes applicables ([NBN EN 912]).

  ---

  #### 24.42.2 a Anneaux
  - **Description** : Anneaux fermés ou ouverts insérés dans des éléments en bois adjacents. Types définis par [NBN EN 912] : A1 à A6 (double face), B1 à B4 (simple face). A1 et B1 sont les plus courants.
  - **Matériaux** : Conformes aux normes [NBN EN 14545] et [NBN EN 912]. Protection anticorrosion adaptée à la classe d’emploi et au bois.
  - **Mise en œuvre** : Usinage préalable, montage sans jeu, profondeur des logements > pénétration + 2 mm. Dimensionnement selon [NBN EN 1995-1-1/A2].

  ---

  #### 24.42.2 b Crampons
  - **Description** : Plaques avec dents triangulaires ou pointes, simple ou double face. Types définis par [NBN EN 912] : C1 à C11. C1 à C5, C10 et C11 sont les plus courants.
  - **Matériaux** : Conformes aux normes [NBN EN 14545] et [NBN EN 912]. Protection anticorrosion selon classe d’emploi et bois.
  - **Mise en œuvre** : Installation par presse ou masse, pénétration complète. Fraisage autorisé pour éviter les espaces. Utilisation limitée aux résineux hors zones de forte nodosité. Dimensionnement selon [NBN EN 1995-1-1/A2].

  ---

  #### 24.42.2 c Plaques dentées
  - **Description** : Plaques métalliques avec dents poinçonnées à 90°, reliant des pièces de bois dans le même plan.
  - **Matériaux** : Acier (épaisseur 0,9 à 3 mm) conforme aux normes [NBN EN 10143], [NBN EN ISO 9445], [NBN EN 10346], [NBN EN 100882]. Protection anticorrosion minimale Z275, ou acier inoxydable pour conditions sévères.
  - **Mise en œuvre** : Installation par presse (plateau ou rouleau). Pré-enfoncement au marteau interdit. Bois avec humidité ≤ 22%. Assemblages symétriques avec plaques identiques.

  ---

  #### Mesurage
  - **Unité** : Par pièce (pc).
  - **Code** : Compris ou quantité nette.
  - **Nature du marché** : PM (par défaut), QF, QP.
  - **24.42.2a Connecteurs de surface - anneaux CCTB 01.12** — `section:24.42.2a`, article, profondeur 6, pages 1099-1100
  - **24.42.2b Connecteurs de surface - crampons CCTB 01.11** — `section:24.42.2b`, article, profondeur 6, pages 1101-1103
  - **24.42.2c Connecteurs de surface - plaques dentées CCTB 01.11** — `section:24.42.2c`, article, profondeur 6, pages 1104-1105
document_parent: "[[documents/CCTB/cctb-t2-superstructures/index|CCTB T2 — Superstructures 01.13 — Index]]"
section_precedente: "[[documents/CCTB/cctb-t2-superstructures/560-24-42-1-assemblages-par-tiges-cctb-01-07|24.42.1 Assemblages par tiges CCTB 01.07]]"
section_suivante: "[[documents/CCTB/cctb-t2-superstructures/562-24-42-3-systemes-de-connexion-cctb-01-10|24.42.3 Systèmes de connexion CCTB 01.10]]"
tags: [document-section, cctb]
sources: [561_24.42.2_connecteurs_de_surface_cctb_01.07.md]
created: 2026-04-28
updated: 2026-04-28
...
|Diamètre|v. [NBN EN 912], ou<br>- 2,5%|<br>v.[NBN EN 912], ou<br>+ 2,5%|+/- 1%|
