...
section_id: "section:41.4"
ordre_document: 65
titre: "41.4 Systèmes de façades CCTB 01.11"
aliases: [CCTB T4 — Fermetures / Finitions extérieures 01.13 — 65 41.4 Systèmes de façades CCTB 01.11]
resume_section: |-
  **Résumé : 41.4 Systèmes de façades CCTB 01.11**

  Les systèmes de façades incluent la fourniture et la pose de tous les éléments nécessaires, y compris les façades légères (rideaux, semi-rideaux, panneaux). Ces façades, non porteuses, assurent les fonctions d’un mur extérieur. Les matériaux et techniques utilisés (profilés, accessoires, étanchéité, quincaillerie, etc.) doivent respecter les normes applicables ([NBN EN 13830:2015+A1], [NBN B 25-002-1], etc.).

  **Performances requises :**
  - **Étanchéité et résistance** : Perméabilité à l’air, étanchéité à l’eau, résistance au vent selon la norme [NBN B 25-002-1].
  - **Thermique et acoustique** : Conformité aux réglementations régionales et normes acoustiques ([NBN S 01-400]).
  - **Sécurité** : Résistance à l’effraction ([NBN EN 1627]), aux chocs ([NBN EN 14019]), au feu ([AR 1994-07-07]), et, si spécifié, à l’explosion ou aux balles.
  - **Durabilité** : Profilés conformes ([NBN EN 14024]), vitrages dimensionnés selon [NBN S 23-002].

  **Exécution :**
  - Respect des normes ([NBN B 25-002-1], [NIT 283], [NIT 221]).
  - Contrôles rigoureux avant et après pose.
  - Essais obligatoires si les performances ne sont pas spécifiées.

  **Documents de référence :**
  Normes techniques et réglementations spécifiques aux matériaux, performances et mise en œuvre.
...
section_precedente: "[[documents/CCTB/cctb-t4-fermetures-finitions-exterieures/64-41-32-7-portes-de-garage-a-usage-collectif-a-enroulement-en-grillage-cctb-01-04|41.32.7 Portes de garage à usage collectif à enroulement en grillage CCTB 01.04]]"
section_suivante: "[[documents/CCTB/cctb-t4-fermetures-finitions-exterieures/66-41-41-systemes-de-facade-vep-vitrage-exterieur-parclose-cctb-01-02|41.41 Systèmes de façade VEP (vitrage extérieur parclosé) CCTB 01.02]]"
tags: [document-section, cctb]
sources: [65_41.4_systèmes_de_façades_cctb_01.11.md]
created: 2026-04-28
updated: 2026-04-28
...
|•La classe d’exposition<br>Le choix des classes est donné|au vent (définie dans la<br>au tableau suivant.|au vent (définie dans la<br>au tableau suivant.|norme [NBN B 25-002-|norme [NBN B 25-002-|1])|1])|
|---|---|---|---|---|---|---|
|Classe d'exposition au vent|Classe CW3||Classe CW4||Classe CW5||
|Perméabilité à l’air<br>[NBN EN 12152]|A3||A3||A4||
|Étanchéité à l’eau<br>[NBN EN 12154]|R5|300 Pa|R6|450 Pa|R7|600 Pa|
|Résistance mécanique au vent<br>[NBN EN 13116]|<br>Charge caractéristique de vent : wK= 0,80 x ce(z)qref 50ans. cp<br>Charge accrue de vent wU= 1,25 x ce(z)qref 50ans.cp||||||
|Classe d'exposition au vent|Classe CW6||Classe CW7||Classe CW8||
|Perméabilité à l’air<br>[NBN EN 12152]|A4||A4||A4||
|Étanchéité à l’eau<br>[NBN EN 12154]|RE 750|750 Pa|RE 900|900 Pa|RE 1050|1050 Pa|
|Résistance mécanique au vent<br>[NBN EN 13116]|<br>Charge caractéristique de vent : wK= 0,80 x ce(z)qref 50ans. cp<br>Charge accrue de vent wU= 1,25 x ce(z)qref 50ans.cp||||||
...
|[4](04_4_t4_fermetures_finitions_extérieures_cctb_01.13.md)|Le cambrioleur expérimenté utilise en plus des outils tels que scie, marteau, hache,<br>ciseau, burin,perceuse électriqueportative à batterie.|
...
|Classes d’essais<br>Choc extérieur|Hauteur de chute<br>[mm]|Classes d’essais<br>Choc intérieur|Hauteur de chute<br>[mm]|
|---|---|---|---|
